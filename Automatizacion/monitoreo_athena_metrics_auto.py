...
def generate_html_report(print_data_dic, css_content,js_content):
    ...
    f.close()
    print(f'> Reporte {file_path} generado')
    
if __name__ == "__main__":
    print('> Iniciando ejecución de script reporte de metricas athena...')
    current_directory = os.path.dirname(os.path.abspath(__file__))
    ruta_imagen = current_directory+ruta_imagen
    js_path = current_directory+js_path
    css_path = current_directory+css_path
    ruta_b64ND = current_directory+ruta_b64ND
    ...
    main()
    print('> Finalizando ejecución de script reporte de metricas athena...')