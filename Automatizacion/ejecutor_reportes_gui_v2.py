...
def run_program():
    ...
    if not usuario or not contrasena or not url:
        ...
        try:
            ...
            credenciales = getCredencialesAWS(usuario,contrasena,url,code)
...
tk.Label(margin_frame, text="Code:").grid(row=2, column=0, sticky="w")
code_entry = tk.Entry(margin_frame, width=40)
code_entry.grid(row=2, column=1, padx=5, pady=5)

tk.Label(margin_frame, text="URL:").grid(row=3, column=0, sticky="w")
url_entry = tk.Entry(margin_frame, width=40)
url_entry.insert(0, URL_DEFAULT)
url_entry.grid(row=3, column=1, padx=5, pady=5)

tk.Label(margin_frame, text="FECHA_INICIO:").grid(row=5, column=0, sticky="w")
...
FECHA_INICIO_entry.grid(row=5, column=1, padx=5, pady=5)
tk.Label(margin_frame, text="FECHA_FIN:").grid(row=6, column=0, sticky="w")
FECHA_FIN_entry = DateEntry(margin_frame, date_pattern='dd/MM/yyyy')
FECHA_FIN_entry.set_date(datetime.now() - timedelta(days=1))
FECHA_FIN_entry.grid(row=6, column=1, padx=5, pady=5)
...
log_text.grid(row=9, column=0, columnspan=2, pady=10)
